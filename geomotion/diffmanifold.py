...
class DifferentialMap(md.ManifoldFunction):
    ...
    def __init__(self,
        ...
        if output_basis is None:
            output_chart = output_defining_basis

        # If the defining function is itself a ManifoldFunction, extract its defining function
        if isinstance(defining_function, md.ManifoldFunction):
            defining_function_raw = defining_function.defining_function
        else:
            defining_function_raw = defining_function
