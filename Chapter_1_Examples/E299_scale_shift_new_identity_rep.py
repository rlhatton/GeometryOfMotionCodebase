...
ax.scatter(point_set[0][0], point_set[0][1], edgecolor='black', facecolor='black', label='$g_{1}$')
ax.scatter(point_set[1][0], point_set[1][1], edgecolor=spot_color, facecolor='white', label='$g_{1}$')
ax.scatter(point_set[2][0], point_set[2][1], edgecolor='black', facecolor=spot_color, label='$g_{2}$')
ax.scatter(point_set[3][0], point_set[3][1], edgecolor='black', facecolor='white', marker=r'$\odot$', label='$g_{3}$')
