...
print("Initial set in Cartesian coordinates is ", str(q_set[0].value), " and ", str(q_set[1].value))

# Transition the set into polar coordinates
q_set_polar = q_set.transition(1)

#
print("Set in Polar coordinates is ", str(q_set_polar[0].value), " and ", str(q_set_polar[1].value))

q_set_cartesian = q_set_polar.transition(0)

print("Set back in Cartesian coordinates ", str(q_set_cartesian[0].value), " and ", str(q_set_cartesian[1].value))
