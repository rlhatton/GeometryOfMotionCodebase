...
print("The left velocity corresponding to g_dot=", g_dot, " is g_circ_l=", g_dot.left, " or ", g_dot.L_generator(g_dot.configuration), " or ", g_dot * g.inverse)
print("The right velocity corresponding to g_dot=", g_dot, " is g_circ_r=", g_dot.right, " or ", g_dot.R_generator(g_dot.configuration), " or ", g.inverse * g_dot)
